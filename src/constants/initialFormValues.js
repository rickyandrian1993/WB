    ...
    return {
      ...
      driver_nm:
        values.driver_nm.trim().length === 0
          ? 'Tidak boleh kosong.'
          : values.driver_nm.trim().length > 20
          ? 'Max karakter 20.'
          : null,
      farmer: values.farmer.trim().length > 20 ? 'Max karakter 20' : null,
      ...
      loader_nm: values.loader_nm.trim().length > 20 ? 'Max karakter 20.' : null,
      ...
      pcc_customer_cd:
        values.pcc_customer_cd === null || values.pcc_customer_cd === ''
          ...
          : null,
      pcc_vehicle_cd:
        values.pcc_vehicle_cd.trim().length === 0
          ? 'Tidak boleh kosong.'
          : values.pcc_vehicle_cd.trim().length > 11
          ? 'Max karakter 11'
          : null,
      ...
      seal_number: values.seal_number.trim().length > 20 ? 'Max karakter 20' : null,
      supplier:
        values.supplier.trim().length === 0
          ? 'Tidak boleh kosong.'
          : values.supplier.trim().length > 20
          ? 'Max karakter 20.'
          : null,
...
export { loginForm, initialValues }
